...
func GenerateTxOpts(ctx context.Context, client *ethclient.Client, auth auth.Auth, cfg TxConfig) (*bind.TransactOpts, error) {
...
func SignTransferTx(ctx context.Context, client *ethclient.Client, auth auth.Auth, to common.Address, amount *big.Int, cfg TxConfig) (*types.Transaction, error) {
